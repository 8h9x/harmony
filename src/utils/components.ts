...
export function transformComponent(
    ...
    return d.map((data: unknown) => {
        ...
        if (e.components !== undefined) {
            e.components = transformComponent(
                e.components as MessageComponentData[]
            )
        }
        ...
        if (
            ...
            e.style =
                TextInputStyle[
                    e.style.toUpperCase() as keyof typeof TextInputStyle
                ]
        }
        return e
